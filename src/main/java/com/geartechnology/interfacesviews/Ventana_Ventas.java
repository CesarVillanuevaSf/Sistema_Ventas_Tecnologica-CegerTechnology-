...
import com.geartechnology.sistema_ventas.services.*;
import java.awt.*;
...
public class Ventana_Ventas extends javax.swing.JFrame {
    ...
    public Ventana_Ventas(Empleados empleado) {
        ...
        this.ventaService = com.geartechnology.Principal.SistemaVentasApplication
                .getBean(VentaService.class);
        this.clienteService = com.geartechnology.Principal.SistemaVentasApplication
